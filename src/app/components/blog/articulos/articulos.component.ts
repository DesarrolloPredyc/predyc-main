import { Component, Inject, PLATFORM_ID,ElementRef, Renderer2, HostListener, ViewChildren, QueryList, LOCALE_ID } from '@angular/core';
import { FlexLayoutModule } from '@angular/flex-layout';
import { IconService } from '../../../services/icon.service';
import { ArticleService, ArticleWithAuthorName } from '../../../shared/services/article.service';
import { ArticleCategoryJson, ArticleData, ArticleTagJson } from '../../../shared/models/article.model';
...
import { CategoryJson } from '../../../shared/models/category.model';
...
export class ArticulosComponent {
  ...
  ngOnInit() {
    ...
    this.route.data.subscribe((result: {data: any}) => {
