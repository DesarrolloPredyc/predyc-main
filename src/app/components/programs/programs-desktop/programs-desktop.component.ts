...
@Component({
  selector: 'app-programs-desktop',
  standalone: true,
  imports: [CommonModule, FooterComponent,FloatingNotificationComponent],
  providers: [IconService],
  templateUrl: './programs-desktop.component.html',
  styleUrls: ['./programs-desktop.component.css']
})

export class ProgramsDesktopComponent implements OnInit {
