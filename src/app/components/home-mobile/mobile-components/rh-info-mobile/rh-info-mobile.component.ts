...
@Component({
  selector: 'app-rh-info-mobile',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './rh-info-mobile.component.html',
  styleUrls: ['./rh-info-mobile.component.css']
})
export class RhInfoMobileComponent implements OnInit {
